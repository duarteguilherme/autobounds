...
def main() -> None:
    ...
    parser.add_argument("--r", type=int, default=2000, help="Number of Monte Carlo datasets (R).")
    ...
    print(
        ...
        f"rate={args.subsample_rate}, method=recentered_subsampling, ci_workers={args.ci_workers}",
        flush=True,
    )
