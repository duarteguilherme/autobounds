...
#     problem = causalProblem(dag, {'Z': 2})
#     problem.set_ate('W', 'Y')
#     # Explictly setting these strata to 0
#     problem.set_p_to_zero(problem.p('W(Z=0)=1'))
#     problem.set_p_to_zero(problem.p('W(Z=1)=1'))
#     problem.set_p_to_zero(problem.p('W(Z=2)=0'))
#     problem.set_p_to_zero(problem.p('W(Z=3)=0'))
#     #problem.set_p_to_zero([ i[1][0] for i in problem.p('W(Z=0)=1')]) 
#     #problem.set_p_to_zero([ i[1][0] for i in problem.p('W(Z=1)=1')])
#     #problem.set_p_to_zero([ i[1][0] for i in problem.p('W(Z=2)=0')])
#     #problem.set_p_to_zero([ i[1][0] for i in problem.p('W(Z=3)=0')])
...
# #    problem.add_constraint(problem.p('W(Z=3)=0'))  # prob of this expression == 0
