...
def test_parse():
    ...
    x = Parser(y, {'X': 2})
    assert x.parse('Y = 1&X = 0') == [('Z0', 'X00.Y10'), ('Z0', 'X00.Y11'), 
            ('Z0', 'X01.Y10'), ('Z0', 'X01.Y11'), ('Z1', 'X00.Y10'),
            ('Z1', 'X00.Y11'), ('Z1', 'X10.Y10'), ('Z1', 'X10.Y11')]
    ...
    x = Parser(y, {'X': 2})
    assert x.parse('Y = 1& X = 1') == [('Z0', 'X1.Y0010'), ('Z0', 'X1.Y0011'), ('Z0', 'X1.Y0110'), 
            ('Z0', 'X1.Y0111'), ('Z0', 'X1.Y1010'), ('Z0', 'X1.Y1011'), ('Z0', 'X1.Y1110'),
            ('Z0', 'X1.Y1111'), ('Z1', 'X1.Y0001'), ('Z1', 'X1.Y0011'), ('Z1', 'X1.Y0101'),
            ('Z1', 'X1.Y0111'), ('Z1', 'X1.Y1001'), ('Z1', 'X1.Y1011'), ('Z1', 'X1.Y1101'), ('Z1', 'X1.Y1111')]
